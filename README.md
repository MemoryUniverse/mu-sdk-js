...
its hosted counterpart even ships: sponsorship goes toward keeping this SDK — and its parity
with the Python SDK — maintained and documented while `mu-server`'s beta comes together. No perks —
